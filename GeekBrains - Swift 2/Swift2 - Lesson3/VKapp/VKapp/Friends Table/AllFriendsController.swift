...
class AllFriendsController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "VKFriendCell", for: indexPath) as! VKFriendsTVCell
        // Get a friend for specific row
        let friend = friends[indexPath.row]
        // Set friend to Cell Label
